...
@section('title', 'Health Pulse Product Development --AIRID')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-heading">
                            <h1 class="banner-title top_title">Health Pulse Product Development</h1>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <h4 class="text-bold border p-3 text-center text-danger">
                        Health Pulse Product Development
                    </h4>
