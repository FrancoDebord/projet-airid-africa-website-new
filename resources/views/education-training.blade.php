            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <p class="mt-3 text-justify">
                        <strong class="title-section"> Building African expertise for sustainable public health impact
                        </strong>
                    </p>
                    <hr>
                    ...
                    <p class="text-justify mt-2">
                        ...
                        to lead high-impact
                        research and drive sustainable health improvements across the continent.
                    </p>

                    <hr>

                    <p class="mt-3 text-justify">
                        <strong class="title-section"> Graduate Programmes (Under Development)
                        </strong>
                    </p>
                    <hr>
                    ...
                    <ul class="mt-2 text-justify">
                        <li>
                            <strong>Master of Science in Public Health</strong>
                        </li>
                        <li>
                            <strong>Master of Science in Epidemiology</strong>
                        </li>
                        <li>
                            <strong>Master of Science in Medical Parasitology and Entomology</strong>
                        </li>
                    </ul>
                    ...
                    <p class="mt-3 text-justify">
                        <strong class="title-section">Technical Training and Professional Development
                        </strong>
                    </p>
                    <hr>
                    ...
                    <h5 class="title-section mt-2">Why It matters</h5>
                ...
                <div class="col-12 mt-3">
                    <h3 class="title-section">Short Courses</h3>

                    <hr>

                    <p class="mt-3 text-justify">
                        <strong class="" style="color: #000">Technical Training and Professional Development
                        </strong>
                    </p>
                    <hr>
                    ...
                    <h4 class="title-section">List of Available Short Courses</h4>
                    ...
                    <hr>
                     <h4 class="title-section mt-2">Course format</h4>
