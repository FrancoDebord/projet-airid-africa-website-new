<div class="about-team-content">
    <h2 class="section-title mb-4">
        <i class="fas fa-flask"></i> Research Team
    </h2>

    <p class="section-lead mb-4">
        AIRID’s research team includes scientists, project managers, field and laboratory staff, and data specialists who deliver our portfolio of studies and evaluations.
    </p>

    <div class="team-block">
        <h3 class="team-block-title">
            <i class="fas fa-microscope"></i> Scientists &amp; Project Staff
        </h3>
        <p class="section-content mb-3">
            Our research team works across infectious disease surveillance, vector control evaluation, intervention trials, epidemiology, and laboratory and field operations. Many team members also contribute to training, mentorship, and capacity strengthening.
        </p>
        <p class="section-content mb-0">
            View profiles and contact information for our research staff.
        </p>
    </div>
    ...
    @else
        <p class="section-content mb-3">No staff profiles in this category yet. They will appear here once assigned to Research Team.</p>
    @endif

    <a href="{{ route('staffAirid', ['category' => 'research_team']) }}" class="team-link mt-3">
        <i class="fas fa-user-friends"></i> View research team directory
    </a>
</div>
