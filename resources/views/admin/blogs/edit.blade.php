        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-white rounded h-100 p-4">
                    <h6 class="mb-4">Modifier un Blog</h6>
                    ...
                    <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('titre_blog') is-invalid @enderror" id="titre_blog" name="titre_blog" value="{{ old('titre_blog', $blog->titre_blog) }}" required>
                            @error('titre_blog')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('resume') is-invalid @enderror" id="resume" name="resume" rows="3" placeholder="Court résumé qui apparaîtra dans les listes">{{ old('resume', $blog->resume) }}</textarea>
                            @error('resume')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description_sans_html') is-invalid @enderror" id="description_sans_html" name="description_sans_html" rows="5" placeholder="Description en texte simple">{{ old('description_sans_html', $blog->description_sans_html) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description_riche') is-invalid @enderror" id="description_riche" name="description_riche" rows="10" placeholder="Description avec formatage HTML">{{ old('description_riche', $blog->description_riche) }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('date_blog') is-invalid @enderror" id="date_blog" name="date_blog" value="{{ old('date_blog', $blog->date_blog ? date('Y-m-d', strtotime($blog->date_blog)) : '') }}">
                                @error('date_blog')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
