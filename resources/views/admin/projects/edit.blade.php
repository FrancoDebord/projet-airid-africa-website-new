                    ...
                    <form action="{{ route('admin.projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('short_title_project') is-invalid @enderror" id="short_title_project" name="short_title_project" value="{{ old('short_title_project', $project->short_title_project) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('long_title_project') is-invalid @enderror" id="long_title_project" name="long_title_project" value="{{ old('long_title_project', $project->long_title_project) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('category_id') is-invalid @enderror" id="category_id" name="category_id">
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('category_id', $project->category_id) == $category->id ? 'selected' : '' }}>{{ $category->nom_categorie ?? 'Catégorie #' . $category->id }}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('etat_projet') is-invalid @enderror" id="etat_projet" name="etat_projet" required>
                                    <option value="ongoing" {{ old('etat_projet', $project->etat_projet) == 'ongoing' ? 'selected' : '' }}>En cours</option>
                                    <option value="ended" {{ old('etat_projet', $project->etat_projet) == 'ended' ? 'selected' : '' }}>Terminé</option>
                                    <option value="abandoned" {{ old('etat_projet', $project->etat_projet) == 'abandoned' ? 'selected' : '' }}>Abandoné</option>
                                </select>
                                @error('etat_projet')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('date_debut_project') is-invalid @enderror" id="date_debut_project" name="date_debut_project" value="{{ old('date_debut_project', $project->date_debut_project) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('date_fin_project') is-invalid @enderror" id="date_fin_project" name="date_fin_project" value="{{ old('date_fin_project', $project->date_fin_project) }}">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('creator_id') is-invalid @enderror" id="creator_id" name="creator_id" required>
                                    ...
                                    @foreach($personnels as $personnel)
                                        <option value="{{ $personnel->id }}" {{ old('creator_id', $project->creator_id) == $personnel->id ? 'selected' : '' }}>{{ $personnel->prenom_personnel }} {{ $personnel->nom_personnel }}</option>
                                    @endforeach
                                </select>
                                @error('creator_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('study_director') is-invalid @enderror" id="study_director" name="study_director">
                                    ...
                                    @foreach($personnels as $personnel)
                                        <option value="{{ $personnel->id }}" {{ old('study_director', $project->study_director) == $personnel->id ? 'selected' : '' }}>{{ $personnel->prenom_personnel }} {{ $personnel->nom_personnel }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('project_manager') is-invalid @enderror" id="project_manager" name="project_manager">
                                    ...
                                    @foreach($personnels as $personnel)
                                        <option value="{{ $personnel->id }}" {{ old('project_manager', $project->project_manager) == $personnel->id ? 'selected' : '' }}>{{ $personnel->prenom_personnel }} {{ $personnel->nom_personnel }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('sponsor_id') is-invalid @enderror" id="sponsor_id" name="sponsor_id">
                                ...
                                @foreach($sponsors as $sponsor)
                                    <option value="{{ $sponsor->id }}" {{ old('sponsor_id', $project->sponsor_id) == $sponsor->id ? 'selected' : '' }}>{{ $sponsor->nom_partenaire }}</option>
                                @endforeach
                            </select>
                            @error('sponsor_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('resume') is-invalid @enderror" id="resume" name="resume" rows="3">{{ old('resume', $project->resume) }}</textarea>
                            @error('resume')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description_sans_html') is-invalid @enderror" id="description_sans_html" name="description_sans_html" rows="5">{{ old('description_sans_html', $project->description_sans_html) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description_riche') is-invalid @enderror" id="description_riche" name="description_riche" rows="8">{{ old('description_riche', $project->description_riche) }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                @if($project->seconde_photo)
                                    @php
                                        $photoName = basename($project->seconde_photo);
                                        $photoPath = null;
