        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-white rounded h-100 p-4">
                    <h6 class="mb-4">Modifier un partenaire</h6>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nom_partenaire') is-invalid @enderror" 
                                       id="nom_partenaire" name="nom_partenaire" value="{{ old('nom_partenaire', $partner->nom_partenaire) }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('nom_long_partenaire') is-invalid @enderror" 
                                       id="nom_long_partenaire" name="nom_long_partenaire" value="{{ old('nom_long_partenaire', $partner->nom_long_partenaire ?? '') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('type_partenaire') is-invalid @enderror" 
                                    ...
                                    <option value="funding_partner" {{ old('type_partenaire', $partner->type_partenaire ?? '') == 'funding_partner' ? 'selected' : '' }}>Funding Partners</option>
                                    <option value="industry_partner" {{ old('type_partenaire', $partner->type_partenaire ?? '') == 'industry_partner' ? 'selected' : '' }}>Industry Partners</option>
                                    <option value="accreditation_partner" {{ old('type_partenaire', $partner->type_partenaire ?? '') == 'accreditation_partner' ? 'selected' : '' }}>Accreditation Body</option>
                                    <option value="Work partner" {{ old('type_partenaire', $partner->type_partenaire ?? '') == 'Work partner' ? 'selected' : '' }}>Research Partners</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="logo_partenaire" class="form-label">Logo</label>
                                ...
                                <input type="file" class="form-control @error('logo_partenaire') is-invalid @enderror" 
                                       id="logo_partenaire" name="logo_partenaire" accept="image/*">
                                <small class="form-text text-muted">Laisser vide pour conserver le logo actuel. Formats acceptés: JPEG, PNG, JPG, GIF, SVG. Taille max: 2MB</small>
                                ...
                                <div id="logo-preview" class="mt-2" style="display: none;">
                                    ...
                                    <p class="text-muted small mt-1">Nouveau logo</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" class="form-control @error('site_web') is-invalid @enderror" 
                                       id="site_web" name="site_web" value="{{ old('site_web', $partner->site_web ?? '') }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="url" class="form-control @error('linkedin') is-invalid @enderror" 
                                       id="linkedin" name="linkedin" value="{{ old('linkedin', $partner->linkedin ?? '') }}" 
